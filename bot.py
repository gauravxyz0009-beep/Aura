...
# ====================== MAIN BOT ======================
def main():
    print("✅ Bot Started - Improved Data Detection")
    offset = 0
    while True:
        try:
            ...
            for update in data.get("result", []):
                ...
                # MENU
                if text == "/start":
                    keyboard = {"keyboard": [["📱 Phone Lookup"], ["🆔 Aadhaar Lookup"], ["👥 Invite Friends", "📞 Contact Admin"]], "resize_keyboard": True}
                    ...
                    prompt = "10 digit mobile number" if "Phone" in text else "12 digit Aadhaar number"
                ...
                # ==================== LOOKUP ====================
                    ...
                    try:
                        ...
                        if (not api_data) or ("not found" in data_str) or ("no data" in data_str) or len(data_str) < 40:
                            ...
                            result = f"✅ {display_type} Lookup Result:\n\n<pre>{formatted}</pre>"
